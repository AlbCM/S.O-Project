...
public class WaitingCellView extends ListCell<Process> {
    ...
    public WaitingCellView()  {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/Views/WaitingCellView.fxml"));
